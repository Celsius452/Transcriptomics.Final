---
title: "interact5 = W1EGCG + W1Placebo - W2EGCG - W2Placebo, # Significant means that EGCG is having a statistically differential response between the two time points, relative to the control"
output:
  html_document:
    df_print: paged
---
...
#genesum = 45 + 1 = 46 log2(46) = 5.52 = ~5.5, everything below 5 on the above graph, so we want to keep everything 45 and above
...
interact5 = W1EGCG + W1Placebo - W2EGCG - W2Placebo, # Significant means that EGCG is having a statistically differential response between the two time points, relative to the control
```{r}
topTable(nfit2, coef = "interact5",  adjust="BH") #we want to specify a specific coefficient, we can look at the Treatment effect between EGCG vs Treatment in the interaction of week 1 and 2 Zonal treatment.
...
This uses the coefficient "interact4" of the following interaction of EGCG vs Treatment in the interaction of week 1 and 2
...
Converting the Ensemble to Entrez was achived with this code:
