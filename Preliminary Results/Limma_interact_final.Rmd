...
```{r}
volcanoplot(nfit2, "interact", highlight = 10, main="Zonal interaction trt vs ctrl wk1-wk2")#The higlight=10 highlights the top 10, but gives the rownames... Changing to Ensembl gene name truncates the name, so it is not useful. However, we can capture the row name and get the gene name, but why bother, as the names are already in the top10 gene list above from the toptable() function. So see above ^)
```
...
```{r}
#install Libraries needed for KEGG Enrifhment Analysis
...
pv.out_htmp1a <- pathview(gene.data = diffexpgenes_names_df$entrez, pathway.id = "hsa00565", species = "hsa")
#Repeat for the second result
pv.out_htmp1b <- pathview(gene.data = diffexpgenes_names_df$entrez, pathway.id = "hsa00480", species = "hsa")
```
...
pv.out_htmp3a <- pathview(gene.data = diffexpgenes_names_df$entrez, pathway.id = "hsa04144", species = "hsa")
#Repeat for the second result
pv.out_htmp3b <- pathview(gene.data = diffexpgenes_names_df$entrez, pathway.id = "hsa04614", species = "hsa")
```
...
pv.out_htmp4a <- pathview(gene.data = diffexpgenes_names_df$entrez, pathway.id = "hsa05219", species = "hsa")
#Repeat for the second result
pv.out_htmp4b <- pathview(gene.data = diffexpgenes_names_df$entrez, pathway.id = "hsa05213", species = "hsa")
```
